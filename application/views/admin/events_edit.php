     ...
     <div class="col-md-8">
         <div class="col-md-6">
             <div class="form-group">
                 <small>Titulo:</small>
                 <input type="text" name="title" placeholder="Titulo" class="form-control" value="{event_edit}{title}{/event_edit}">
             </div>
             <div class="form-group">
                 <small>Fecha:</small>
                 <input type="date" name="date" value="{event_edit}{date}{/event_edit}" placeholder="Fecha" class="form-control">
             </div>
             <div class="form-group">
                 <small>Tag:</small>
         ...
         <div class="col-md-12">
             <div class="form-group">
                 ...
                 <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Descripcion">
                     {event_edit}{description}{/event_edit}
                 </textarea>
             </div>
         </div>
     </div>
